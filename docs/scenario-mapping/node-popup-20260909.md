...
4. The persistent yellow **View scenario detail** CTA opens S1 in a separate tab using the user-selected M0.1 Version 2 workshop sample at Summary (`#6`). The original map and source selection remain open. Other scenarios retain their existing detail behavior until their workshop samples are ready.
