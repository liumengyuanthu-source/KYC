...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3013 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: 06-CHK03.png

Call log:
  - Expect "toHaveScreenshot(06-CHK03.png)" with timeout 5000ms
