...
await probe(['UX-15','UX-20'],'journey-camera-escape-focus',async h=>{
 ...
 // Existing focusOrigin restores on requestAnimationFrame; observe completion, not the preceding frame.
 await h.page.waitForFunction(()=>document.activeElement?.dataset.value==='SCN-GAP'||document.activeElement?.dataset.scene==='SCN-GAP');
