...
const dir='prototype/qa/d3/d-regression/',base='http://127.0.0.1:8765/prototype/',results=[],errors=[];
...
function record(){fs.writeFileSync(dir+'browser-results.json',JSON.stringify({at:new Date().toISOString(),command:'node prototype/qa/d3/mainline-browser.mjs',browser:browser.version(),results,errors},null,2)+'\n');}
