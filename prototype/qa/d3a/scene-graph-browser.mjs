// D3A regression relocation of prototype/qa/d3/scene-graph-browser.mjs; prior receipts remain intact.
// D3 regression copy of prototype/qa/batch-d/scene-graph-browser.mjs; original evidence preserved.
...
const dir='prototype/qa/d3a/d-regression/',results=[],browser=await chromium.launch({executablePath:'/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',headless:true});
