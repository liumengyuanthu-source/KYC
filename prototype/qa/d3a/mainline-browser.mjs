// D3A regression relocation of prototype/qa/d3/mainline-browser.mjs; prior receipts remain intact.
// D3 regression copy of prototype/qa/batch-d/mainline-browser.mjs; original evidence preserved.
...
const dir='prototype/qa/d3a/d-regression/',base='http://127.0.0.1:8765/prototype/',results=[],errors=[];
...
function record(){fs.writeFileSync(dir+'browser-results.json',JSON.stringify({at:new Date().toISOString(),command:'node prototype/qa/d3a/mainline-browser.mjs',browser:browser.version(),results,errors},null,2)+'\n');}
