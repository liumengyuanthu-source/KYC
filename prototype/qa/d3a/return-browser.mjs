// D3A regression relocation of prototype/qa/d3/return-browser.mjs; prior receipts remain intact.
// D3 regression copy of prototype/qa/batch-d/return-browser.mjs; original evidence preserved.
...
const dir='prototype/qa/d3a/d-regression/',seed=JSON.parse(fs.readFileSync(dir+'host-saved-session.json')),results=[];
