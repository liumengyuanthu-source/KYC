...
export function refineLayout(locale){
 ...
 if(intro){
  ...
  intro.querySelector('.intro-copy').textContent=zh?'从客户受理到获准交易，沿角色活动查看源流程、交接与待解痛点。':'From client intake to clearance. Follow each role’s work, handoffs and unresolved pain points.';
