...
export function initialNavigation() { return {page:'studio',mode:'story',locale:'en-AU',comparison:'target',trigger:'new-relationship',role:'ROLE-KYCOPS',stage:'S1',scenario:'SCN-SCOPE',modal:false,storyCursor:0,routeId:'ROUTE-NEW-REL-01',camera:{anchor:'SCN-SCOPE',offset:0},zoom:'read',step:'requirements',returnToken:null,graph:{scene:null,focus:null,branch:null},dGraph:{graph:'DG-D01',focus:null,cursor:0,playing:false},specialistBeat:null,conditionDomain:'conflicts',agreementRevision:null,liveAgreementRevision:null,liveCaseRevision:null,dependency:null,reference:null,productScroll:0}; }
